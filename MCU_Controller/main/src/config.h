...
#define M_CHARIOT_CURRENT_MA 500
#define M_CHARIOT_CAL_CURRENT_MA 100
#define M_CHARIOT_MICROSTEP 16      // default motor microstep
#define M_CHARIOT_STEPS_PER_TURN 200
#define M_CHARIOT_TRAVEL_PER_TURN 10
#define M_CHARIOT_SPEED_MM 10
#define M_CHARIOT_CAL_SPEED 1
